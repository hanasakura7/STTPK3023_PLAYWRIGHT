                    ...
                    <div class="container my-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="class" id="class"
                                ...
                                <option>Geografi7</option>
                                <option>Pendidikan Islam/Pendidikan Moral</option>
                                <option>Pendidikan Jasmani dan Pendidikan Kesihatan</option>
                                <option>Pendidikan Seni Visual</option> -->
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <select class="form-select" aria-label="Default select example" name="class"
                                            id="search-class">
                                            <!--<option selected>Bahasa Melayu</option>-->
                                            <!--<option>Bahasa Inggeris</option>-->
                                            <!--<option>Matematik</option>-->
                                            <!--<option>Sains</option>-->
                                            <!--<option>Sejarah</option>-->
